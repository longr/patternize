...
colorChecker <- function(IDlist,
  ...
  for(n in 1:length(IDlist)){
    ...
    # X-Rite colorChecker
    if(colorCheckerType == 'GWBCC24' & is.null(fixedModel)){
      ...
      l1 <- c(1, 125, 80, 56) # brown
      l2 <- c(2, 246, 172, 152)
      l3 <- c(3, 103, 130, 167)
      l4 <- c(4, 76, 114, 31)
      l5 <- c(5, 149, 146, 199)
      l6 <- c(6, 105, 191, 173) # cyan
      ...
      l19 <- c(19, 255, 255, 255) # white?
      l20 <- c(20, 227, 227, 227)
      l21 <- c(21, 192, 192, 192)
      l22 <- c(22, 136, 134, 134)
      l23 <- c(23, 61, 61, 60)
      l24 <- c(24, 51, 51, 51) #black
